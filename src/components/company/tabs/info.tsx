        ...
        <Box>
            <List sx={{width: '100%', bgcolor: 'background.paper'}}>
                <ListItem alignItems="flex-start">
                    ...
                    <ListItemText
                        primary={"Description"}
                        secondary={selectedCompany?.Description}
                    />
                </ListItem>
                ...
                <ListItem alignItems="flex-start">
                    ...
                    <ListItemText
                        primary={"Industry"}
                        secondary={selectedCompany?.Industry}
                    />
                </ListItem>
                <Divider variant="inset" component="li"/>
                <ListItem alignItems="flex-start">
                    ...
                    <ListItemText
                        primary={"HQ Location"}
                        secondary={selectedCompany?.['HQ Location']}
                    />
                </ListItem>
                <Divider variant="inset" component="li"/>
                    ...
                    <>
                        <ListItem alignItems="flex-start">
                            ...
                            <ListItemText
                                ...
                                secondary={selectedCompany?.["Total Funding Amount (in USD)"].toLocaleString("en-US")}
                            />
                        </ListItem>
                        <Divider variant="inset" component="li"/>
                    </>
                    ...
                    <>
                        <ListItem alignItems="flex-start">
                            ...
                            <ListItemText
                                ...
                                secondary={`${selectedCompany?.["Last Funding Amount (in USD)"].toLocaleString("en-US")} (Type: ${selectedCompany["Last Funding Type"]})`}
                            />
                        </ListItem>
                        <Divider variant="inset" component="li"/>
                    </>
                ...
                {selectedCompany?.["Founders"] ? (
                    <>
                        <ListItem alignItems="flex-start">
                            ...
                            <ListItemText
                                primary={`Founders`}
                                secondary={`${selectedCompany?.["Founders"]}`}
                            />
                        </ListItem>
                        <Divider variant="inset" component="li"/>
                    </>
                ...
                {selectedCompany?.["Investors"] ? (
                    <>
                        <ListItem alignItems="flex-start">
                            ...
                            <ListItemText
                                primary={`Investors`}
                                secondary={`${selectedCompany?.["Investors"]}`}
                            />
                        </ListItem>
                        <Divider variant="inset" component="li"/>
                    </>
